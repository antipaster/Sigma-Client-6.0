...
public class MoveUtils {
    ...
    public static void setSpeed(EventUpdate event, double speed) {
        if(isWalking()) {
            event.setX(mc.thePlayer.motionX = -Math.sin(getDirection()) * speed);
            event.setZ(mc.thePlayer.motionZ = Math.cos(getDirection()) * speed);
        } else {
