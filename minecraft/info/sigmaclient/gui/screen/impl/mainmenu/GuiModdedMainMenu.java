...
public class GuiModdedMainMenu extends ClientMainMenu {
    ...
    void drawLigmaScreen(int mouseX, int mouseY){
         ...
         font69.drawString("Sigma", w / 2 - font69.getWidth("Sigma")/2, height / 2 - 105, -1);
    ...
    void initChangeLogs(){
        ...
        ChangelogComponent cl69 = new ChangelogComponent( c69, "6.0 Changelog",cl4_11.getX() + (int) cl4_11.getWidth()+10, this.height + 30, tFont2);
        changeLs.add(cl4_0);
        changeLs.add(cl4_1);
        changeLs.add(cl4_11);
        changeLs.add(cl69);
